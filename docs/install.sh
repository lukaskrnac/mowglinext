...
#     --gnss-connection=uart --lidar=ldlidar-uart --tfluna=none
#
...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    --help|-h)
      ...
      echo "  --gnss-connection  Universal GNSS serial link: usb or uart"
      echo "                     (the installer still asks for the actual device path and baud)"
