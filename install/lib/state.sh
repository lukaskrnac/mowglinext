...
is_allowed_installer_key() {
  ...
  case "$key" in
    ...
    GNSS_BACKEND|GNSS_STATUS_SOURCE|GNSS_STACK|GNSS_RECEIVER_FAMILY|GNSS_TRANSPORT|GNSS_SERIAL_DEVICE|GNSS_SERIAL_BAUD|GNSS_FRAME_ID|\
    GNSS_NTRIP_ENABLED|GNSS_NTRIP_HOST|GNSS_NTRIP_PORT|GNSS_NTRIP_MOUNTPOINT|GNSS_NTRIP_USERNAME|GNSS_NTRIP_PASSWORD|\
    GNSS_NTRIP_GGA_ENABLED|GNSS_NTRIP_GGA_INTERVAL_S|\
    GPS_CONNECTION|GPS_RUNTIME_MODE|GPS_PROTOCOL|GPS_PORT|GPS_BY_ID|GPS_UART_DEVICE|GPS_BAUD|UNICORE_COM_PORT|\
